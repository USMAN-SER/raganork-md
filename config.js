...
module.exports = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '923351300389-1632403322@g.us',
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~f52d2e191b63050d45cc1e718d054dd7:3167736f4b7a6c457431733d').trim() || '',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f", "deb80cd12ababea1c9b9a8ad6ce3fab2", "78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '919074309534-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'U S M A N;M A N I;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "M A N I",
    BOT_NAME: process.env.BOT_NAME || 'U S M A N',
